(async () => {
  ...
  const requiredChecks = {
    ...
    doorwayRealignsAfterLayout:
      DoorwayPlacementEngine?.realignDeclaredHallwayOpenings instanceof Function,
    engineCallsFinalRealignment:
      CartographerEngine?.generate?.toString?.().includes(
        "realignDeclaredHallwayOpenings"
      ) === true,
  ...
  const roomReport = result.sectors.map(sector => {
    ...
    return {
      ...
      realignedAfterLayout: hallOpening?.realignedAfterLayout === true,
      hallwayDoorValid:
  ...
  const report = {
    ...
    hallwayDoorsRealigned: roomReport
      .filter(room => room.hallwayFace !== "NONE")
      .every(room => room.realignedAfterLayout === true),
  ...
  const doorReport = openings
    ...
    .map(opening => {
      ...
      return {
        ...
        realignedAfterLayout: opening.realignedAfterLayout === true,
